...
'INSTANT VB NOTE: The variable resources was renamed since it may cause conflicts with calls to static members of the user-defined type with this name:
			Dim resources_Conflict As New System.ComponentModel.ComponentResourceManager(GetType(SampleDashboard))
			...
			Me.dashboardExcelDataSource1.ResultSchemaSerializable = resources_Conflict.GetString("dashboardExcelDataSource1.ResultSchemaSerializable")
